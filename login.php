...
<body>
    ...
    <header>
            ...
            <div>
                <a href="login.php">Home</a> | <a href="#">Download</a>
            </div>
        </header>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="file" name="marksheet_diploma" id="marksheet_diploma" accept="image/*" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Certificate</td>
                        ...
                        <td>
                            ...
                            <input type="file" name="marksheet_certificate" id="marksheet_certificate" accept="image/*" required>
                        </td>
                    </tr>
                </table>
            </fieldset>
